...
const getShoutTransactionPopulated = (criteria, projection, populate, callback) => {
  Models.ShoutTransaction.find(criteria).select(projection).populate(populate)
    .exec(callback)
}
...
module.exports = {
  ...
  getShoutTransactionPopulated: getShoutTransactionPopulated
};
